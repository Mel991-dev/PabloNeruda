-- ============================================================================
-- SCRIPT SQL - SISTEMA DE GESTIÓN ACADÉMICA
...
-- ============================================================================
-- TABLA 1: USUARIOS
-- Gestión de acceso al sistema por roles
-- ============================================================================
...
-- ============================================================================
-- TABLA 4: ACUDIENTES
-- Información de padres/tutores de los estudiantes
-- ============================================================================
...
-- ============================================================================
-- TABLA 5: ESTUDIANTE_ACUDIENTE (Relación M:N)
-- Vincula estudiantes con sus acudientes
-- ============================================================================
...
-- ============================================================================
-- TABLA 6: CURSOS
-- Definición de grados y secciones
-- ============================================================================
CREATE TABLE cursos (
...
-- ============================================================================
-- TABLA 7: MATRICULAS
-- Registro de estudiantes en cursos por año
-- ============================================================================
...
-- ============================================================================
-- TABLA 9: PROFESOR_MATERIA_CURSO (Relación M:N)
-- Asignación de profesores a materias en cursos específicos
-- ============================================================================
...
-- Password: admin123 (hasheado con bcrypt - este es un ejemplo, debes generar el hash real)
...
-- Insertar cursos para el año 2025
...
-- Trigger para validar capacidad del curso antes de insertar matrícula
DELIMITER //
...
-- Procedimiento: Reporte completo de un estudiante
DELIMITER //
...
-- Procedimiento: Estadísticas de un curso
DELIMITER //
